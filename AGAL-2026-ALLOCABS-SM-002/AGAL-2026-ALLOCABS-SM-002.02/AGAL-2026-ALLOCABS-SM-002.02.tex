...
\fancyhead[L]{\fontsize{7.6}{10}\selectfont\color{softgray}\textsc{Sarva Creation}}
\fancyhead[R]{\fontsize{7.6}{10}\selectfont\color{softgray}\textsc{Synthetic Monitoring -- Proposal}}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=south west, text=mutedblue, align=left, text width=15.8cm]
     ...
     {\fontsize{9}{14}\selectfont\textsc{Prepared for} \ Sarva Creation \quad\textbullet\quad \textsc{Prepared by} \ Naveen V \quad\textbullet\quad September 04, 2026};
...
\begin{description}[
  ...
  \item[Delivery] Up to 1 month from the initiation of development, required access, and confirmed scope.
...
\fontsize{8.3}{10}\selectfont\textcolor{softgray}{Naveen \ -- \ Confidential. Prepared exclusively for Sarva Creation.}
